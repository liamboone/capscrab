...
/*
 * This version allows for 7p letters and stops players from
 * bidding once they have seven letters.
 * 
 */
...
public class GameEngine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("CIS 700 Spring 2013 - Letter Game " + VERSION);
    ...
    public void updateUI()
    {
        ...
        for(int loop=0;loop<gameconfig.PlayerList.size();loop++)
        {
            ...
            if(gameconfig.BidList.get(lastbidIndex) != null)
            {
				...
				Object formatargs[] = {
						winner_id, l.getWonBy(), l.getBidvalues().get(winner_id),l.getWinAmmount()
				};
